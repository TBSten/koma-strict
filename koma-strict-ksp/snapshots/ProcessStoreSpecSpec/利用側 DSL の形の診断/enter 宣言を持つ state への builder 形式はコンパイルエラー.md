...
## Input:LceLoadingBuilderFormUsage.kt
...
```text
e: file://<TMPDIR>/Kotlin-Compilation<N>/sources/LceLoadingBuilderFormUsage.kt:4:22 No value passed for parameter 'enter'.
e: file://<TMPDIR>/Kotlin-Compilation<N>/sources/LceLoadingBuilderFormUsage.kt:5:17 Function invocation 'nextState(...)' expected.
e: file://<TMPDIR>/Kotlin-Compilation<N>/sources/LceLoadingBuilderFormUsage.kt:5:27 Unresolved reference 'toContent'.
```
