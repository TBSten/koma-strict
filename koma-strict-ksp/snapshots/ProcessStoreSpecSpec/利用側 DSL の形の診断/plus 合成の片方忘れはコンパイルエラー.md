...
## Input:FlowPlusMissingHalfUsage.kt
...
e: file://<TMPDIR>/Kotlin-Compilation<N>/sources/FlowPlusMissingHalfUsage.kt:10:23 Argument type mismatch: actual type is 'RefreshRefreshCommonHandlers', but 'RefreshHandlersScope.() -> RefreshHandlers' was expected.
e: file://<TMPDIR>/Kotlin-Compilation<N>/sources/FlowPlusMissingHalfUsage.kt:19:23 Argument type mismatch: actual type is 'RefreshGroupHandlers', but 'RefreshHandlersScope.() -> RefreshHandlers' was expected.
```
