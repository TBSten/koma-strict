...
1) Run `./gradlew :koma-strict-runtime:publishToMavenLocal`
2) Open `~/.m2/repository/me/tbsten/koma/strict/`
...
2) Add developer id, name, email and the project url to  
   `./koma-strict-runtime/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :koma-strict-runtime:publishAndReleaseToMavenCentral --no-configuration-cache`
